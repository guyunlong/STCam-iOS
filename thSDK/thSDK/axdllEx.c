...
bool DevCfg_to_NewDevCfg(TDevCfg* DevCfg, TNewDevCfg* NewDevCfg)
{
    ...
    NewDevCfg->DevInfo.FunctionMask.Value = DevCfg->DevInfoPkt.FunctionMask.Value;
    ...
    NewDevCfg->ExtractCfg.AudioGainLevel = DevCfg->AudioCfgPkt.AudioGainLevel;//δ�õ�
...
{
    i32 i, m;
    //����Ҫ memset(DevCfg, 0, sizeof(DevCfg));
    //DevInfo
    ...
    DevCfg->DevInfoPkt.FunctionMask.Value = NewDevCfg->DevInfo.FunctionMask.Value;
    ...
    if (NewDevCfg->ExtractCfg.VerifyCode == Head_CmdPkt)//0xAAAAAAAA
    {
        ...
        DevCfg->AudioCfgPkt.AudioGainLevel = NewDevCfg->ExtractCfg.AudioGainLevel;//δ�õ�
...
//-----------------------------------------------------------------------------
void Json_cgi_GetDevInfo(char* cgiBuf, TDevCfg* DevCfg)//ͨ����ҳ���ã�ȡ���豸��Ϣ
{
    ...
    sprintf(Str, "\"FunctionMask\":\"%d\",", DevCfg->DevInfoPkt.FunctionMask.Value); strcat(cgiBuf, Str);
...
//-----------------------------------------------------------------------------
void Json_cgi_GetUserLst(char* cgiBuf, TDevCfg* DevCfg)//ͨ����ҳ���ã�ȡ���û��б�
{
...
//-----------------------------------------------------------------------------
void Json_cgi_GetNetCfg(char* cgiBuf, TDevCfg* DevCfg)//ͨ����ҳ���ã�ȡ����������
{
    int len;
    char Str[1024];
...
//-----------------------------------------------------------------------------
void Json_cgi_GetWiFiCfg(char* cgiBuf, TDevCfg* DevCfg)//ͨ����ҳ���ã�ȡ��WIFI����
{
...
//-----------------------------------------------------------------------------
void Json_cgi_GetWiFiSTALst(char* cgiBuf, TDevCfg* DevCfg)//ͨ����ҳ���ã�ȡ�ñ�����������WIFI·�����б�
{
...
//-----------------------------------------------------------------------------
void Json_cgi_GetVideoCfg(char* cgiBuf, TDevCfg* DevCfg)//ͨ����ҳ���ã�ȡ����Ƶ����
{
    int w, h;
    char Str[1024];
...
//-----------------------------------------------------------------------------
void Json_cgi_GetAudioCfg(char* cgiBuf, TDevCfg* DevCfg)//ͨ����ҳ���ã�ȡ����Ƶ����
{
    int len;
    char Str[1024];
...
//-----------------------------------------------------------------------------
void Json_cgi_GetHideArea(char* cgiBuf, TDevCfg* DevCfg)//ͨ����ҳ���ã�ȡ��������������
{
    int len;
    char Str[1024];
...
//-----------------------------------------------------------------------------
void Json_cgi_GetMDCfg(char* cgiBuf, TDevCfg* DevCfg)//ͨ����ҳ���ã�ȡ���ƶ��������
{
...
//-----------------------------------------------------------------------------
void Json_cgi_GetDiskCfg(char* cgiBuf, TDevCfg* DevCfg)//ͨ����ҳ���ã�ȡ��TF����Ϣ
{
...
//-----------------------------------------------------------------------------
void Json_cgi_GetRecCfg(char* cgiBuf, TDevCfg* DevCfg)//ͨ����ҳ���ã�ȡ��¼������
{
    int len;
    char Str[1024];
...
//-----------------------------------------------------------------------------
void Json_cgi_GetFTPCfg(char* cgiBuf, TDevCfg* DevCfg)//ͨ����ҳ���ã�ȡ��FTP����
{
    int len;
    char Str[1024];
...
//-----------------------------------------------------------------------------
void Json_cgi_GetSMTPCfg(char* cgiBuf, TDevCfg* DevCfg)//ͨ����ҳ���ã�ȡ���ʼ�����
{
    int len;
    char Str[1024];
...
//-----------------------------------------------------------------------------
void Json_cgi_GetP2PCfg(char* cgiBuf, TDevCfg* DevCfg)//ͨ����ҳ���ã�ȡ��P2P����
{
    int len;
    char Str[1024];
