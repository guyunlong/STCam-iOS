...
-(void)initView{
    ...
    _checkOnBox = [[BEMCheckBox alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_chooseTimeBtn.frame)+kPadding, y, 30, 30)];
    ...
    _power0Box =[[BEMCheckBox alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_powerOffLb.frame), y, 30, 30)];
    ...
    _power1Box =[[BEMCheckBox alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_powerOffLb.frame), y, 30, 30)];
    ...
    _power2Box =[[BEMCheckBox alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_powerOffLb.frame), y, 30, 30)];
    ...
    _power3Box =[[BEMCheckBox alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_powerOffLb.frame), y, 30, 30)];
    ...
    _power4Box =[[BEMCheckBox alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_powerOffLb.frame), y, 30, 30)];
